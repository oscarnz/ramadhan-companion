    ...
    return (
        <TooltipProvider>
            <Tooltip>
                ...
                <TooltipContent className="flex gap-3 text-xs text-gray-500 z-1 w-64 rounded-md border bg-popover p-3 shadow-md outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2">
                    <MapPinned size={30} />
                    <span>
        ...
        <div className="flex flex-col rounded-xl border bg-zinc-950 p-4 space-y-2">
            <div className="group relative rounded-xl border bg-zinc-950 p-4 text-green-400 flex flex-row items-center transition-color hover:border-green-400 overflow-hidden">
                ...
                <div className="absolute bottom-0 right-0 w-40 rounded overflow-hidden">
                    <MasjidIcon className="w-40 h-40 text-gray-500 group-hover:text-green-400 opacity-[30%] group-hover:opacity-[50%] transition-all group-hover:-rotate-[15deg] relative -bottom-6 -right-2 group-hover:scale-[120%]" />
                </div>
            </div>
